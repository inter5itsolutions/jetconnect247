...
import { Linkedin, Instagram, MessageCircle, Mail, Phone, MapPin, GraduationCap } from 'lucide-react';
  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200 pt-16 lg:pt-20 pb-8 lg:pb-10 px-6 lg:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12 lg:mb-20">
        ...
        <div className="sm:col-span-2 lg:col-span-1 space-y-5 lg:space-y-6">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 lg:w-10 lg:h-10 rounded-xl bg-brand-silver-blue/10 flex items-center justify-center">
              <GraduationCap className="w-4 h-4 lg:w-5 lg:h-5 text-brand-silver-blue" />
            </div>
            <div>
        ...
        {/* Contact */}
        <div>
          <h4 className="text-brand-white font-semibold mb-5 lg:mb-6 uppercase tracking-widest text-xs">Contact</h4>
          <ul className="space-y-4 lg:space-y-5 text-sm">
      ...
      <div className="max-w-7xl mx-auto pt-8 lg:pt-10 border-t border-gray-200 flex flex-col sm:flex-row lg:flex-row justify-between items-center gap-4 lg:gap-6">
        <p className="text-[10px] text-brand-soft-silver uppercase tracking-widest text-center sm:text-left">© {currentYear} JETCONNECT247 PILOT TRAINING CENTER. ALL RIGHTS RESERVED.</p>
